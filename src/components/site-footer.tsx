...
import { Instagram, Facebook, Music, Mail, Phone, MapPin } from "lucide-react";

export function SiteFooter() {
  const socials = [
    { Icon: Instagram, href: "https://www.instagram.com/marvelousrealestate", label: "Instagram" },
    { Icon: Facebook, href: "https://web.facebook.com/p/Marvelous-realestate", label: "Facebook" },
    { Icon: Music, href: "https://www.tiktok.com/@marvelousrealestates", label: "TikTok" },
  ];
  return (
    <footer className="border-t border-border bg-[oklch(0.13_0.02_260)] text-[oklch(0.95_0_0)]">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-4 lg:px-8">
        <div className="lg:col-span-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold">Marvelous Real Estate</span>
          </div>
          ...
          <div className="mt-6 flex gap-3">
            {socials.map(({ Icon, href, label }) => (
              <a
                ...
                href={href}
                aria-label={label}
                className="flex h-9 w-9 items-center justify-center rounded-full border border-white/15 transition-colors hover:bg-primary hover:border-primary"
                target="_blank"
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-white/80">
            ...
            <li className="flex items-center gap-2"><Mail className="h-4 w-4" /> marvelousrealestate.et@gmail.com</li>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-4 py-5 text-xs text-white/60 sm:flex-row sm:px-6 lg:px-8">
          <p>© {new Date().getFullYear()} Marvelous Real Estate. All rights reserved.</p>
