...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — Bereka Real Estate" },
      { name: "description", content: "Bereka Real Estate is a private residential developer in Addis Ababa building affordable, family-focused apartments in Nifas Silk-Lafto." },
      { property: "og:title", content: "About — Bereka Real Estate" },
      ...
      <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
        <div>
          ...
          <p className="mt-5 text-muted-foreground">
            Bereka Real Estate is a private residential developer headquartered at the Haile Garment
